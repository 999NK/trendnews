...
import { 
  Search, Calendar, User, Share2, ChevronRight, Twitter, Clock, Eye, 
  Heart, MessageCircle, Bookmark, Menu, X, Info, Mail, Globe, 
  TrendingUp, Star, Users, Target, Award, Home, BookOpen, Rss
} from "lucide-react";
...
function shareOnTwitter(article: Article) {
  ...
  // Fill remaining characters with excerpt if possible
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/blog" className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 -mt-1">Notícias em Tempo Real</p>
                </div>
              </Link>
            </div>
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <Link href="/blog" className="text-gray-700 hover:text-red-600 font-medium transition-colors flex items-center space-x-1">
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t border-gray-200 py-4">
              <div className="flex flex-col space-y-3">
                <Link href="/blog" className="text-gray-700 hover:text-red-600 font-medium px-2 py-1 flex items-center space-x-2">
                  <Home className="w-4 h-4" />
                  <span>Início</span>
                </Link>
                <button 
      ...
      <section className="bg-gradient-to-r from-red-600 via-red-700 to-red-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-red-100 max-w-3xl mx-auto">
            Mantenha-se informado com as notícias mais relevantes e atualizadas do Brasil e do mundo
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                  ...
                  <div className="lg:flex">
                    ...
                    <div className="lg:w-1/2 p-8 lg:p-12">
                      ...
                      <div className="flex flex-wrap gap-3">
                        ...
                        <Button variant="ghost" size="lg" className="text-gray-600 hover:text-red-600">
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {otherArticles.map((article) => (
                    <Card key={article.id} className="overflow-hidden bg-white shadow-lg hover:shadow-2xl transition-all duration-300 border-0 rounded-xl group">
        ...
        {filteredArticles.length > 7 && (
          <div className="text-center mt-16">
            <Button variant="outline" size="lg" className="border-red-200 text-red-600 hover:bg-red-50 px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                Portal de notícias que mantém você informado sobre os assuntos mais relevantes e 
                tendências do Brasil e do mundo. Notícias de qualidade, sempre atualizadas e verificadas.
              </p>
              <div className="flex items-center space-x-4">
                <a 
                  href="https://x.com/tthunter999" 
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-300">
                <li className="hover:text-white transition-colors cursor-pointer">Política</li>
                <li className="hover:text-white transition-colors cursor-pointer">Economia</li>
                <li className="hover:text-white transition-colors cursor-pointer">Tecnologia</li>
                <li className="hover:text-white transition-colors cursor-pointer">Cultura</li>
                <li className="hover:text-white transition-colors cursor-pointer">Esportes</li>
                <li className="hover:text-white transition-colors cursor-pointer">Internacional</li>
              </ul>
            </div>
            ...
            <CardContent className="p-8">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-3xl font-bold text-gray-900">Sobre o TrendNews</h2>
                </div>
                <Button 
                  variant="ghost" 
                  size="sm"
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    O TrendNews é um portal de notícias dedicado a manter você informado sobre os 
                    assuntos mais relevantes e tendências do Brasil e do mundo. Nosso compromisso é 
                    com a qualidade, veracidade e atualização constante das informações.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4">
                    Somos uma equipe de jornalistas e especialistas em comunicação, liderada por 
                    <strong> tthunter999</strong>, focada em trazer conteúdo de qualidade e relevante 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-start space-x-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Informação clara e verificada</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-2">
                      <div className="w-2 h-2 bg-red-600 rounded-full mt-2"></div>
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Conteúdo relevante e bem apurado</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-2">
                      <div className="w-2 h-2 bg-red-600 rounded-full mt-2"></div>
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Notícias em tempo real</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-2">
                      <div className="w-2 h-2 bg-red-600 rounded-full mt-2"></div>
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Cobertura equilibrada dos fatos</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="text-center">
                  <p className="text-gray-600 mb-4">Siga-nos nas redes sociais para não perder nenhuma novidade!</p>
                  <a 
                    href="https://x.com/tthunter999" 
                    target="_blank" 
                    rel="noopener noreferrer"
